          ...
          <div className="card ">
            <form className="body-profile  bg-primary grid grid-cols-1 place-justify-item" onSubmit={handleChangePassword}>
              ...
              <label className="label">
                ...
                <input className="input input-bordered w-full max-w-xs" type="text" placeholder="Old Password" id="oldPassword"name="oldPassword"value={oldPassword}onChange={handleInputChange}/>
              </div>
              ...
              <label className="label">
                ...
                <input className="input input-bordered w-full max-w-xs" type="text" placeholder="New Password" id="newPassword"name="newPassword"value={newPassword}onChange={handleInputChange}/>
              </div>
              ...
              <label className="label">
                ...
                <input className="input input-bordered w-full max-w-xs" type="text" placeholder="Confirm Password" id="confirmPassword"name="confirmPassword"value={confirmPassword}onChange={handleInputChange}/>
              </div>
