    ...
    <div>
        ...
        <div className="learn-body grid grid-cols-5  bg-primary text-base-100">
            ...
            <div className="learn-content menu bg-primary w-56 text-base-100 col-span-4 w-full mb-10">
              ...
              <p>Reverse Engineering เป็นหมวดหมู่ของการแข่งขันทางความปลอดภัย (CTF) ที่เน้นการวิเคราะห์และทำความเข้าใจกับโค้ด
              ...
              <h1 className="mt-100px ">เล่น CTF เพื่ออะไร?</h1>

              <h2>เข้าใจในพิ้นฐานของการแข่งขัน CTF </h2>
              ...
              <h2>เพื่อได้รับความรู้พื้นฐานความรู้ด้าน Cybersecurity </h2>
              <p>เข้าใจพื้นฐานของความมั่นคงปลอดภัย ความสำคัญของความมั่นคงปลอดภัยในโลกดิจิทัล.ประเภทของการละเมิดความมั่นคงปลอดภัย</p>

              <h2>หลังจากที่ได้เข้าร่วมกิจกรรม มีความตระหนักรู้ด้าน Cybersecurity </h2>
