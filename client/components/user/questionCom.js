...
function Questioncom() {
    ...
    return (
        <div className="practice-body grid grid-cols-3 gap-4 place-items-center text-base-100 col-span-3">
            <a className="practice-button text-primary place-items-center btn btn-ghost" onClick={()=>document.getElementById('my_modal_3').showModal()}>General skill</a> {/* ชื่อหน้าปุ่ม */}
            <dialog id="my_modal_3" className="modal ">
              <div className="modal-box bg-primary-content">
                ...
                <div className="grid grid-cols-3 grid-rows-9">
                    <h3 className="font-bold text-lg text-primary col-start-1 col-end-1">General Skills</h3>{/* ชื่อโจทย์ */}
                    <p className="text-primary text-primary row-start-2">Tags:</p>{/* หมวดหมู่ */}
                    <p className="text-primary text-primary row-start-2 col-start-3 col-end-3">Point :</p>{/* คะแนน */}
                    <div className="questionunderline card  row-start-3 col-start-1 col-end-4"></div>{/* ไม่ต้องสนใจ */}
                    ...
                    <div className="questionunderline card  row-start-6 col-start-1 col-end-4"></div>{/* ไม่ต้องสนใจ */}
                    ...
                    <div className=" row-start-7 text-base-100 col-start-3 col-end-4 mt-2 mb-2"><Submitbutton/></div> {/* ปุ่ม submit */}
                    <div className="questionunderline card  row-start-8 col-start-1 col-end-4"></div>{/* ไม่ต้องสนใจ */}

                    <button className="hintbutton btn w-full text-base-100 mt-2 " onClick={handleHintClick}>{/* ปุ่มhint*/}
